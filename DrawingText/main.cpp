...
int main(int argc, char* args[])
{
	...
	while (ProgramIsRunning())
	{
		...
		char buffer[64];
		sprintf_s(buffer, "I can count to 1000 really fast: %d", counter);

		DrawOutlineText(Backbuffer, "I am the king of Drawing Text!", 100, 100, Font, 255, 0, 0);
		DrawOutlineText(Backbuffer, "I can draw text in any color I want!", 100, 150, Font, 0, 255, 0);
